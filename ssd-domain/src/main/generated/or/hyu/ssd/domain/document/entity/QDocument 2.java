...
public class QDocument extends EntityPathBase<Document> {
    ...
    public final NumberPath<Double> reviewDifferentiationAvg = createNumber("reviewDifferentiationAvg", Double.class);

    public final NumberPath<Double> reviewFeasibilityAvg = createNumber("reviewFeasibilityAvg", Double.class);

    public final NumberPath<Double> reviewFinancialAvg = createNumber("reviewFinancialAvg", Double.class);

    public final NumberPath<Double> reviewTotalAvg = createNumber("reviewTotalAvg", Double.class);
