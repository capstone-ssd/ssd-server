...
public class EvaluatorReviewJpaEntity extends BaseJpaEntity {
    ...
    public static EvaluatorReviewJpaEntity of(int feasibility, int differentiation, int financial, String comment, DocumentJpaEntity doc, MemberJpaEntity reviewer) {
